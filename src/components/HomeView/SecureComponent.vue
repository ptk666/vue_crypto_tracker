  ...
  <div class="p-5 lg:px-16 2xl:px-20 md:py-16 lg:py-32 2xl:py-60 bg-black text-white">
    <div class="grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mt-10">
      <div class="md:flex md:flex-col md:justify-center">
        ...
        <div class="mt-2 lg:mt-4 xl:mt-6 text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl 2xl:leading-tight font-semibold">
          <p>Watch. Anytime.</p>
          <p>Anywhere</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 grid-rows-2 md:grid-rows-1 mt-10 md:mt-40 mb-10">
      <div class="flex flex-col justify-end md:justify-center md:ml-12 2xl:ml-64 items-end md:items-start md:items-first order-first md:order-last mb-5 md:mb-0">
        <p class="text-xs lg:text-md 2xl:text-xl text-blue-500 text-end">Buy and Sell</p>
        <div class="mt-2 lg:mt-4 xl:mt-6 text-2xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-semibold text-end">
          <p class="text-start">Buy and sell in a click!</p>
        </div>
        <div class="mt-3 lg:mt-5 xl:mt-7 2xl:mt-10 text-gray-300">
          <div class="flex items-start">
